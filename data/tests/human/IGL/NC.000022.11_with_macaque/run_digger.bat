...
digger ../NC_000002.11.fasta -locus IGL -sense forward -v_ref Homo_sapiens_IGLV.fasta -j_ref Homo_sapiens_IGLJ.fasta -v_ref_gapped Homo_sapiens_IGLV_gapped.fasta -ref imgt,Homo_sapiens_IGLVJ.fasta ../../../../rhesus_motifs/IGL NC_000002.11.csv
