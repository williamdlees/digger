...
parse_imgt_annotations --save_sequence IMGT000062.fasta "https://www.imgt.org/ligmdb/view?format=IMGT&id=BK063717" IMGT000062_genes.csv IGK
...
compare_annotations -nc IMGT000062.csv IMGT000062_genes.csv forward ../rhemac10_IGL_digger_annotation_compared_to_imgt.csv
cp IMGT000062.csv ..
