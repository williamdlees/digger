...
parse_imgt_annotations --save_sequence IMGT000064.fasta "https://www.imgt.org/ligmdb/view?format=IMGT&id=BK063715" IMGT000064_genes.csv IGH
...
compare_annotations -nc IMGT000064.csv IMGT000064_genes.csv forward ../rhemac10_IGH_digger_annotation_compared_to_imgt
cp IMGT000064.csv ..
