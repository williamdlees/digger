...
parse_imgt_annotations --save_sequence IMGT000063.fasta "https://www.imgt.org/ligmdb/view?format=IMGT&id=BK063716" IMGT000063_genes.csv IGK
...
compare_annotations -nc --filter_annot forward IMGT000063_fw.csv IMGT000063_genes.csv forward ../IMGT000063_digger_annotation_compared_to_imgt_fw.csv
compare_annotations -nc --filter_annot reverse IMGT000063_rev.csv IMGT000063_genes.csv forward ../IMGT000063_digger_annotation_compared_to_imgt_rev.csv
